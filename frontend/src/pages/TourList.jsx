...
export default function TourList() {
  ...
  return (
    <>
      <Navbar />
      <div className="tour-list-page" style={{ padding: "20px", maxWidth: 800, margin: "0 auto" }}>
        <h2>🗺️ Chọn Tour Tham Quan</h2>
          ...
          {tours.map((tour) => (
            ...
            >
              ...
              <div>
                ...
                <p style={{ margin: "0 0 6px", color: "#666", fontSize: 14 }}>{tour.description}</p>
